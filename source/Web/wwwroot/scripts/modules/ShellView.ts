...
import { BufferedTerminal } from './BufferedTerminal';
import { TextReceived } from './ShellHub';

export interface ShellViewSettings {
  parent: JQuery<HTMLElement>;
  hideOnConnection: JQuery<HTMLElement>;
}

export class ShellView {
  private _settings: ShellViewSettings;
  private _sessionId: string;

  constructor(settings: ShellViewSettings, sessionId: string) {
